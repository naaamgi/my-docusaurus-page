...
sidebar_position: 1
sidebar_label: 진단 개요
description: 웹/모바일 취약점 진단 실무 가이드 - OWASP, KISA 기반 점검 항목 및 PoC 템플릿
keywords: [vulnerability assessment, pentest, web, mobile, OWASP, KISA, MASVS]
slug: /assessment
---

# 진단 (Vulnerability Assessment)

> **실무 모의해킹 / 취약점 진단** 현업에서 바로 쓸 수 있도록 정리한 가이드.
> 점검 절차 → 페이로드 → 취약 판정 기준 → 보고서 양식까지 1페이지로 끝낼 수 있게 구성.
...
### 3. 보고서 작성 시 — PoC 양식 활용
각 페이지 하단의 **"PoC 양식" 섹션**을 보고서에 그대로 가져다 쓰면 돼요. 영향도/대응방안도 표준 문구로 들어가 있어서 시간 절약.

---

## 페이지 표준 구조

모든 진단 페이지는 [`_template.md`](./_template) 구조를 따라요:
...
- [Penetration Testing](/penetration/) — 침투 단계별 가이드
- [Redteam](/redteam/) — C2 인프라 구축 등 레드팀 운영
